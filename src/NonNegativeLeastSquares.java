...
public class NonNegativeLeastSquares {
	 ...
	 * 
	 * @param M
	 *            Number of rows (input data points) in the least squares
	 *            problem.
	 * @param N
	 *            Number of columns (output parameters) in the least squares
	 *            problem.
	 * 
	 * @exception IllegalArgumentException
	 *                (unchecked exception) Thrown if <TT>M</TT> &lt;= 0 or
	 *                <TT>N</TT> &lt;= 0.
	 */
	 ...
	 *                (unchecked exception) Thrown if too many iterations
	 *                occurred without finding a minimum (more than 3<I>N</I>
	 *                iterations).
	 */
	public void solve() {
		...
		mainloop: for (;;) {
			...
			secondaryloop: for (;;) {
				...
				++iter;
				if (iter > itmax) {
					throw new TooManyIterationsException("NonNegativeLeastSquares.solve(): Too many iterations");
				}
	 ...
	 * @param i1
	 *            If <TT>i1</TT> &lt; <I>M,</I> the transformation will be
	 *            constructed to zero elements indexed from <TT>i1</TT> through
	 *            <I>M</I>-1. If <TT>i1</TT> &gt;= <I>M,</I> an identity
	 *            transformation will be constructed.
	 * @param u
	 *            An <I>M</I>x<I>N</I>-element matrix. On input, column
	 *            <TT>pivotcol</TT> of <TT>u</TT> contains the pivot vector. On
	 *            output, column <TT>pivotcol</TT> of <TT>u</TT>, along with the
	 *            return value (<TT>up</TT>), contains the Householder
	 *            transformation.
	 * @param pivotcol
	 *            Index of the column of <TT>u</TT> that contains the pivot
	 *            vector.
	 * 
	 * @return The quantity <TT>up</TT> which is part of the Householder
	 *         transformation.
	 */
	 ...
	 *            Index of the pivot element within the pivot vector.
	 * @param i1
	 *            If <TT>i1</TT> &lt; <I>M,</I> the transformation will zero
	 *            elements indexed from <TT>i1</TT> through <I>M</I>-1. If
	 *            <TT>i1</TT> &gt;= <I>M,</I> the transformation is an identity
	 *            transformation.
	 * @param u
	 *            An <I>M</I>x<I>N</I>-element matrix. On input, column
	 *            <TT>pivotcol</TT> of <TT>u</TT>, along with <TT>up</TT>,
	 *            contains the Householder transformation. This must be the
	 *            output of a previous call of
	 *            <TT>constructHouseholderTransform()</TT>.
	 * @param pivotcol
	 *            Index of the column of <TT>u</TT> that contains the
	 *            Householder transformation.
	 * @param up
	 *            The rest of the Householder transformation. This must be the
	 *            return value of the same previous call of
	 *            <TT>constructHouseholderTransform()</TT>.
	 * @param c
	 *            An <I>M</I>x<I>N</I>-element matrix. On input, column
	 *            <TT>applycol</TT> of <TT>c</TT> contains the vector to which
	 *            the Householder transformation is to be applied. On output,
	 *            column <TT>applycol</TT> of <TT>c</TT> contains the
	 *            transformed vector.
	 * @param applycol
	 ...
	 *            <TT>constructHouseholderTransform()</TT>.
	 * @param c
	 *            An <I>M</I>-element array. On input, <TT>c</TT> contains the
	 *            vector to which the Householder transformation is to be
	 *            applied. On output, <TT>c</TT> contains the transformed
	 *            vector.
	 */
	private static void applyHouseholderTransform(int ipivot, int i1, double[][] u, int pivotcol, double up, double[] c) {
		int M = u.length;
	 ...
	 *            Input argument.
	 * @param terms
	 *            A 2-element array. On output, <TT>terms[0]</TT> contains
